...
Cyber's infrastructure repository is the source of truth for Azure resources, permissions, networking, Easy Auth, and Container App configuration. This repository owns only the application source and Docker image. Build and publish immutable images through the company deployment process and Azure Container Registry.

See [AZURE_DEPLOYMENT.md](AZURE_DEPLOYMENT.md) for the container runtime contract and production verification checklist.
